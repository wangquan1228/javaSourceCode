...
<html lang="en">
 ...
 <body>
        <div class="box">
            <h1>请修改密码</h1>
            <form method="post" action="SysUserAction_updatePwd">
            <input type="hidden" name="method" value="addCustomer"/>
            <ul class="clear" >
                  <input type="hidden" name="user.userId" value="${user1.userId}"/>
                <li class="clear">
                <p class="fl">用户名称</p>
                <input type="text" name="user.userName" class="fl"  value="${user1.userName }"/>
                </li>
                <li class="clear">
                <p class="fl">原密码</p>
                <input type="password" name="olduserPassword" class="fl"   />
                </li>
                <li class="clear">
                <p class="fl">新密码</p>
                <input type="password" name="user.userPassword" class="fl"/>
                </li>
