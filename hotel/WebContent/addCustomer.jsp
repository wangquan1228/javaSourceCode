 ...
 <body>
		<div class="box">
			...
			<ul class="clear" >
				...
				<li class="clear">
				<p class="fl">姓名</p>
				<input type="text" name="name" class="fl"  />
				</li>
				<li class="clear">
				<p class="fl">性别</p>
				<input type="text" name="gender" class="fl" />
				</li>
				<li class="clear">
				<p class="fl">身份证</p>
				<input type="text" name="card" class="fl" />
				</li>
				<li class="clear">
				<p class="fl">房间号</p>
				<input type="text" name="roomid" class="fl"/>
				</li>
				<li class="clear">
				<p class="fl">支付金额</p>
				<input type="text" name="payprice" class="fl"/>
				</li>
				<li class="clear">
				<p class="fl">备注</p>
				<input type="text" name="remark" class="fl"/>
				</li>
